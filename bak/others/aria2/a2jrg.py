...
def parse_args(args=None):
    ...
    group.add_argument(
        "--unpause-all", action="store_true", help="Unpause all downloads."
    )
    group.add_argument("--purge", action="store_true", help="Purge download results.")

    group = parser.add_argument_group("other options")
    group.add_argument(
        "-w", "--wait", action="store_true", help="Wait for the download to finish"
    )
    group.add_argument(
        "-i",
        "--interval",
    ...
    group.add_argument(
        "--status", action="store_true", help="Print global status report."
    )
