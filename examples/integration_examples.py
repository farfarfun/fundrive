...
class CloudStorageManager:
    ...
    def sync_file(self, source_drive: str, source_fid: str, 
                  target_drive: str, target_fid: str, filename: str) -> bool:
        """
        在两个云存储之间同步文件
...
class FileBackupService:
    ...
    def backup_directory(self, local_path: str, drive_name: str, 
                        remote_path: str = None, exclude_patterns: List[str] = None) -> bool:
        """
        备份本地目录到云存储
        ...
        try:
            ...
            # 递归备份文件
            return self._backup_recursive(drive, local_path, backup_dir_id, exclude_patterns)
            
        except Exception as e:
            logger.error(f"备份失败: {e}")
            return False
    
    def _backup_recursive(self, drive: BaseDrive, local_path: str, 
                         remote_dir_id: str, exclude_patterns: List[str] = None) -> bool:
        """递归备份目录"""
        ...
        try:
            for item in os.listdir(local_path):
                ...
                if os.path.isfile(item_path):
                    ...
                    self._backup_recursive(drive, item_path, sub_dir_id, exclude_patterns)
...
class CloudFileSearcher:
    ...
    def search_across_drives(self, keyword: str, file_type: str = None) -> Dict[str, List[DriveFile]]:
        """
        跨多个云存储搜索文件
    ...
    def _get_all_files_recursive(self, drive: BaseDrive, dir_id: str) -> List[DriveFile]:
        """递归获取目录下的所有文件"""
        all_files = []
