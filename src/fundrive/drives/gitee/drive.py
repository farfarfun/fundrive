        ...
        **kwargs
        ...
        try:
            ...
            response = requests.get(
                f"{self.base_url}/repos/{self.repo_str}",
                params=params
            )
    ...
    def download_file(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"下载文件失败: 无法获取下载链接")
            return False
        ...
        try:
            ...
            def download_recursive(path: str, local_dir: str):
                ...
                for file in files:
                    total_count += 1
                    try:
                        relative_path = file.fid[len(fid):].lstrip('/') if fid else file.fid
                        ...
                        # 下载文件
                        if self.download_file(file.fid, local_file_dir, os.path.basename(local_path)):
                            success_count += 1
